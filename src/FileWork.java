...
class FileWork {
    ...
    private void initializeKeyAndFinalFilePathAndFinalTextForBruteForce(String initialText, AlgorithmOfCaesar algorithm){
        key = "0";
    ...
    private void initializeFinalTextAndFinalFilePath(String command, AlgorithmOfCaesar algorithm) {
        switch (command) {
            ...
            case "BRUTE_FORCE" -> initializeKeyAndFinalFilePathAndFinalTextForBruteForce(initialText, algorithm);
        }
    }
